 ...
 *
 */
+(void)uploadAmrWithUrl:(NSString *)url  AmrDatas:(NSData *)amr success:(PPHttpRequestSuccess)success failure:(PPHttpRequestFailed)failure withUpLoadProgress:(PPHttpProgress)progress;
